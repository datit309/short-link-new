    ...
    app: {
        head: {
            ...
            meta: [
                ...
                { hid: 'og:url', name: 'og:url', content: 'https://hidelink.top/' },
                {
                    hid: 'og:description',
                    name: 'og:description',
                ...
                { hid: 'og:image', name: 'og:image', property: 'og:image', content: 'https://hidelink.top/client/images/moba_game_banner.jpg' },
                { hid: 'og:image:secure_url', name: 'og:image:secure_url', content: 'https://hidelink.top/client/images/moba_game_banner.jpg' },
                ...
                { property: 'twitter:url', content: 'https://hidelink.top' },
                {
                    name: 'twitter:title',
                    content: 'Website rút gọn link miễn phí, cách đơn giản để tạo url ngắn gọn. Hỗ trợ rút gọn link Google, link Bio, link Facebook, Tiktok giúp chia sẻ liên kết dễ dàng.',
                },
                ...
                { name: 'twitter:image', content: 'https://hidelink.top/client/images/moba_game_banner.jpg' },
            ],
            link: [
