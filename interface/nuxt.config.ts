...
export default defineNuxtConfig({
    ...
    app: {
        head: {
            ...
            meta: [
                { charset: 'utf-8' },
                { name: 'title', content: 'Website rút gọn link miễn phí, cách đơn giản để tạo url ngắn gọn. Hỗ trợ rút gọn link Google, link Bio, link Facebook, Tiktok giúp chia sẻ liên kết dễ dàng.' },
                { name: 'description', content: 'Website rút gọn link miễn phí, cách đơn giản để tạo url ngắn gọn. Hỗ trợ rút gọn link Google, link Bio, link Facebook, Tiktok giúp chia sẻ liên kết dễ dàng.' },
                ...
                { hid: 'og:title', name: 'og:title', property: 'og:title', content: 'Website rút gọn link miễn phí, cách đơn giản để tạo url ngắn gọn. Hỗ trợ rút gọn link Google, link Bio, link Facebook, Tiktok giúp chia sẻ liên kết dễ dàng.' },
                { hid: 'og:site_name', name: 'og:site_name', content: 'Rút gọn link' },
                { hid: 'og:url', name: 'og:url', content: 'https://mobagame.io' },
                { hid: 'og:description', name: 'og:description', property: 'og:description', content: 'Website rút gọn link miễn phí, cách đơn giản để tạo url ngắn gọn. Hỗ trợ rút gọn link Google, link Bio, link Facebook, Tiktok giúp chia sẻ liên kết dễ dàng.' },
                ...
                { hid: 'og:image:alt', name: 'og:image:alt', property: 'og:image:alt', content: 'Website rút gọn link miễn phí, cách đơn giản để tạo url ngắn gọn. Hỗ trợ rút gọn link Google, link Bio, link Facebook, Tiktok giúp chia sẻ liên kết dễ dàng.' },

                { name: 'twitter:card', content: 'summary_large_image' },
                { property: 'twitter:domain', content: 'mobagame.io' },
                { property: 'twitter:url', content: 'https://mobagame.io' },
                { name: 'twitter:title', content: 'Website rút gọn link miễn phí, cách đơn giản để tạo url ngắn gọn. Hỗ trợ rút gọn link Google, link Bio, link Facebook, Tiktok giúp chia sẻ liên kết dễ dàng.' },
                { name: 'twitter:description', content: 'Website rút gọn link miễn phí, cách đơn giản để tạo url ngắn gọn. Hỗ trợ rút gọn link Google, link Bio, link Facebook, Tiktok giúp chia sẻ liên kết dễ dàng.' },
