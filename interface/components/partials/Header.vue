            ...
            .modal-content
                .modal-body.p-4.py-lg-5.position-relative
                    ...
                    div.justify-content-center.d-flex.mb-2
                        nuxt-img.w-75(format="webp" v-if="theme === 'dark'" src='/images/logo.png' alt="hideurl")
                        nuxt-img.w-75(format="webp" v-else src='/images/logo.png' alt="hideurl")
    ...
    nav.navbar.navbar-expand-lg.bg-menu.mt-lg-3
        .container
            a.navbar-brand.me-0(href="/")
                nuxt-img.img-logo.d-none.d-lg-block(format="webp" src='/images/logo.png' alt="hideurl")
                nuxt-img.img-logo.d-lg-none(format="webp" src='/images/favicon.png' alt="hideurl")
            .d-flex.justify-content-center
