...
footer.fixed-bottom
    nav.navbar.navbar-expand-lg.bg-menu.mt-lg-3
        .container.justify-content-between
            a.navbar-brand(href='/')
                img.img-logo-footer.d-none.d-lg-block(src='~/assets/images/logo.png')
            ...
            .d-flex
                a(href="https://hightechk.net" target="_blank" rel="nofollow")
                    img.img-aware.d-none.d-lg-block.py-2(src='@/assets/images/hightechk.net-removebg-preview.png' style='width: 100px')
                    .d-lg-none.d-flex.align-items-center.mt-2
                        img(src='@/assets/images/hightechk.net-removebg-preview.png' style='width: 80px')
</template>
