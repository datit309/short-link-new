...
footer
    nav.navbar.navbar-expand-lg.bg-menu.mt-lg-3
        .container.justify-content-between
            a.navbar-brand(href='/')
                nuxt-img.img-logo-footer.d-none.d-lg-block(format="webp" src='/images/logo.png' alt="hideurl")
                nuxt-img.img-logo-footer.d-lg-none(format="webp" src='/images/favicon.png' alt="hideurl")
            .d-flex
            ...
            .d-flex
                a(href="https://hightechk.net" target="_blank" rel="nofollow")
                    nuxt-img.img-aware.d-none.d-lg-block.py-2(format="webp" src='/images/hightechk.net-removebg-preview.png' style='width: 100px' alt="hightechk")
                    .d-lg-none.d-flex.align-items-center.mt-2
                        nuxt-img(format="webp" src='/images/hightechk.net-removebg-preview.png' style='width: 80px' alt="hightechk")
</template>
